...
export const TareaSummary: React.FC<TareaSummaryProps> = ({ seccionId, periodo, onClose }) => {
    ...
    return (
        <div className="modal-overlay" style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.8)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 1000, padding: '2rem' }}>
            <div className="glass-card" style={{ width: '100%', maxWidth: '1200px', maxHeight: '90vh', overflow: 'auto', padding: '2rem', position: 'relative', background: 'var(--glass-bg)', color: 'var(--text-main)' }}>
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '0.85rem' }}>
                            <thead>
                                <tr style={{ borderBottom: '2px solid var(--glass-border)' }}>
                                    ...
                                    <th style={{ textAlign: 'center', padding: '1rem', color: 'var(--primary)' }}>TOTAL TAREAS (10%)</th>
                                </tr>
                            </thead>
                            <tbody>
                                {estudiantes.map(est => {
